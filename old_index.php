...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if (isset( $_POST['snoEdit'])){
        // Update the record
         ...
         $sql = "UPDATE `record` SET `name` = '$name', `description` = '$description' WHERE `record`.`sno` = $sno";
      ...
      // Sql query to be executed
      $sql = "INSERT INTO `record` (`name`, `description`) VALUES ('$name', '$description')";
      $result = mysqli_query($conn, $sql);
  ...
  ?>
     ...
     <h2>Add Record</h2>
        ...
        <form action="index.php" method="post">
            ...
            <div class="mb-3">
                <label for="desc" class="form-label">Record Description</label>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          ...
          console.log("no click on the confrm");
        }
      })
    })
